...
public class CodeGenVisitorTest implements ImageResources{
	...
	public void prog6() throws Exception {
		...
		show(input);
		byte[] bytecode = genCode(input);		
		String[] commandLineArgs = {"0", "34", "56"}; //create command line argument array to initialize params, none in this case		
		runCode(prog, bytecode, commandLineArgs);	
		assertEquals("0;34;56;56;",RuntimeLog.globalLog.toString());
	}
	...
	public void prog7() throws Exception {
		...
		String[] commandLineArgs = {}; //create command line argument array to initialize params, none in this case		
		runCode(prog, bytecode, commandLineArgs);	
		assertEquals("9;3;3;27;",RuntimeLog.globalLog.toString());
	}
	...
	public void prog8() throws Exception {
		...
		String[] commandLineArgs = {}; //create command line argument array to initialize params, none in this case		
		runCode(prog, bytecode, commandLineArgs);	
		assertEquals("9;",RuntimeLog.globalLog.toString());
	}
	...
	@Test
	public void unaryExprBooleanExl() throws Exception {
		String prog = "unaryExprBooleanExl";
		String input = prog
				+ " boolean g = false;\n"
				+ "g -> SCREEN;\n"
				+ "g = !g;\n"
		...
		assertEquals("false;true;",RuntimeLog.globalLog.toString());
										
	}

	@Test
	public void unaryExprIntExl() throws Exception {
		String prog = "unaryExprIntExl";
		String input = prog
				+ " int g = 0;\n"
				+ "g -> SCREEN;\n"
				+ "g = !g;\n"
		...
		runCode(prog, bytecode, commandLineArgs);		
		show("Log:\n"+RuntimeLog.globalLog);
		assertEquals("0;2147483647;",RuntimeLog.globalLog.toString());							
	}
	
	@Test
	public void unaryExprMinus() throws Exception {
		String prog = "unaryExprMinus";
		String input = prog
				+ " int g = 3;\n"
				+ "g -> SCREEN;\n"
				+ "g = -g;\n"
		...
		runCode(prog, bytecode, commandLineArgs);		
		show("Log:\n"+RuntimeLog.globalLog);
		assertEquals("3;-3;",RuntimeLog.globalLog.toString());									
	}
